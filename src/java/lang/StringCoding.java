...
class StringCoding {
    ...
    /**
     * 判断数组元素是否全部为ANSI字符，即字符范围在[0x0, 0x80) [0000 0000,1000 0000)
      * @param ba
     * @param off
     * @param len
     * @return  false mean all ASCII.
     */
    ...
    private static byte[] encodeUTF8(byte coder, byte[] val, boolean doReplace) {
        ...
        // 判断数组元素是否全部为ANSI字符，false即字符范围在[0x0, 0x80)
            ...
            if(c < 0) {
                ...
                =====================
                   ...
                   |:     10cd efgh
                    ...
                    字节c: abcd efgh --> [1100 00ab,10cd efgh]
                */
