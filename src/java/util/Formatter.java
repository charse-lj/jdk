...
public final class Formatter implements Closeable, Flushable {
     ...
     * 有加号“+”	    正数前显示正号    formatter.format("***%+8d***", 1000);  ***   +1000***
     *                  负数前显示负号	 formatter.format("***%+8d***", -1000);	***   -1000***

     * 有空格“ ”	正数前显示空格        formatter.format("***% 8d***", 1000);  ***   1000***
     *              负号前显示负号	     formatter.format("***% 8d***", -1000); ***   -1000***
